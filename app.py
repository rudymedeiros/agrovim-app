...
def show_last_reading_prediction(df, selected_turbine, model, features, roc_auc):
    ...
    try:
        ...
        prob_falha = model.predict_proba(input_data)[0][1] * 100
        ...
        st.error(f"Erro ao gerar previsão automática: {str(e)}")
